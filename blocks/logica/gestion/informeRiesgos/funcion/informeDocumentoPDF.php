...
class ProcesarInforme {
    ...
    public function contenidoInforme() {
        /* Conexión FrameWork */
        $conexion = "estructura";
...
<page backtop='5mm' backbottom='5mm' backleft='5mm' backright= '5mm' footer='page'>
      ...
      <table align='left' style='width:100%;' >
       ...
       <br>
        ...
        if (isset($_REQUEST['firma_digital']) && $_REQUEST['firma_digital']) {
...

            {
                ...
                {
                    $firmaDigital = base64_decode($usuario['firma_usuario']);
                    $firmaDigital = str_replace("image/svg+xml,", '', $firmaDigital);
                    $firmaDigital = str_replace('<?xml version="1.0" encoding="UTF-8" standalone="no"?><!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd">', '', $firmaDigital);
                    $firmaDigital = str_replace("svg", 'draw', $firmaDigital);

                    $firmaDigital = str_replace("height", 'height="40" pasos2', $firmaDigital);
                    $firmaDigital = str_replace("width", 'width="125" pasos1', $firmaDigital);
                }
                ...
                if ($resultado) {
                    $firmaDigital = str_replace("<path", '<g viewBox="0 0 50 50" transform="scale(0.2,0.2)"><path', $firmaDigital);
                    $firmaDigital = str_replace("/>", ' /></g>', $firmaDigital);
                } else {

                    $firmaDigital = str_replace("<path", '<g viewBox="0 0 50 50" transform="scale(0.09,0.09)"><path', $firmaDigital);
                    $firmaDigital = str_replace("/>", ' /></g>', $firmaDigital);
            ...
            $contenidoPagina .= "</table>
						...
						<page_footer>
							<table style='width:100%;'>
								...
								<td rowspan='2' style='width:50%;text-align:left;'>Firma :<br><br><br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; " . $firmaDigital . "</td>
								</tr>
								<tr>
            ...
            $contenidoPagina .= "</table>
						...
						<page_footer>
							<table style='width:100%;'>
								...
								<td style='width:15%;text-align:left;'>Elaborado por: </td>
								<td style='width:35%;text-align:center;'>" . $usuario['nombre_usuario'] . "</td>
								<td rowspan='2' style='width:50%;text-align:left;'>Firma :</td>
								</tr>
								<tr>
								<td style='width:15%;text-align:left;'>Cargo:</td>
								<td style='width:35%;text-align:center;'>PROFESIONAL SEÑALIZACIÓN MARÍTIMA</td>
