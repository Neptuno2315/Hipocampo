...
class registrarForm {
	...
	function miForm() {
		...
		$atributos ['tipoEtiqueta'] = 'inicio';
		$atributos ["leyenda"] = "Eliminar Proyecto de la Zona de Estudio : " . $_REQUEST ['titulo_proyecto'];
		...
		
		{
			...
			$atributos ['mensaje'] = "¿ Seguro desea Eliminar el Proyecto de la Zona de Estudio : " . $_REQUEST ['titulo_proyecto'] . " ?";
			$tab ++;
