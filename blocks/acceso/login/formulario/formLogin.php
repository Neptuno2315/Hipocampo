...
<header>
    <div id="fondo_base">
        ...
        Sistema de Gestión del Riesgo a la Navegación&nbsp&nbsp<br>del Diseño de Canales&nbsp&nbsp<br>&nbsp&nbsp
...
<?php
    ...
    public function mensaje() {
        ...
        if (isset($_REQUEST['actualizacion_datos'])) {
            ...
            $atributos["etiqueta"] = '';
            $atributos["columnas"] = ''; // El control ocupa 47% del tamaño del formulario
            $atributos['mensaje'] = $this->lenguaje->getCadena('actualizacion_datos');
            echo $this->miFormulario->campoMensaje($atributos);
            unset($atributos);
        }
